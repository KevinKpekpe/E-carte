            ...
            <div class="card-body">
                <div class="dropdown float-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <form action="{{ route('premium.destroy') }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="dropdown-item text-danger">Supprimer mon compte</button>
                        </form>
                        <a href="{{route('premium.client.show',auth()->user()->slug)}}" class="dropdown-item">Voir mes infos</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('premium.update-password') }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        @method('PUT')
