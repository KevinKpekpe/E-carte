                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="text-center mb-4">
                            <h4 class="text-uppercase mt-0">Création de compte</h4>
                        </div>

                        <form action="{{ route('register.premium') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        J'accepte les <a href="javascript: void(0);" class="text-dark">termes &
                                            conditions</a>
                                    </label>
                                </div>
                            </div>
